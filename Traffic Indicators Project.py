...
print(avg_vol_each_month['traffic_volume'])
...
# Next, let's shift our focus to the day of the week. Is there a day of the week where traffic is busier?
...
print(day['traffic_volume'].corr(day['temp']))
print(day['traffic_volume'].corr(day['rain_1h']))
print(day['traffic_volume'].corr(day['snow_1h']))
print(day['traffic_volume'].corr(day['clouds_all']))
